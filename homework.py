...
class InfoMessage:
    ...
    def get_message(self) -> 'str':
        """Строка информационного сообщения о тренировке"""
        return MESSAGE_FORMAT.format(*asdict(self).values())
...
class Training:
    ...
    def get_spent_calories(self) -> float:
        ...
        raise NotImplementedError('Класс наследник должен '
...
def read_package(workout_type: str, data: list) -> Training:
    ...
    try:
        ...
        raise KeyError(f'{workout_type} не поддерживается')


def main(training: Training) -> None:
    """Главная функция."""
    info = training.show_training_info()
    training_string = info.get_message()
